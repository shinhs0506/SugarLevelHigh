...
void DataManager::load(int level) {
...
CameraData DataManager::get_camera_data() {
    return camera_data;
}

BackgroundData DataManager::get_background_data() {
    return background_data;
}

std::vector<PlayerData> DataManager::get_player_data() {
    return player_data_vector;
}

std::vector<EnemyData> DataManager::get_enemy_data() {
    return enemy_data_vector;
}

std::vector<TerrainData> DataManager::get_terrain_data() {
    return terrain_data_vector;
}

std::vector<LadderData> DataManager::get_ladder_data() {
    return ladder_data_vector;
}

int DataManager::get_curr_order_ind() {
    return curr_order_ind;
}

void DataManager::update_camera_data(CameraData camera_data) {
    this->camera_data = camera_data;
}

void DataManager::update_background_data(BackgroundData background_data) {
    this->background_data = background_data;
}

void DataManager::update_player_data(std::vector<PlayerData> player_data_vector) {
    this->player_data_vector = player_data_vector;
}

void DataManager::update_enemy_data(std::vector<EnemyData> enemy_data_vector) {
    this->enemy_data_vector = enemy_data_vector;
}

void DataManager::update_terrain_data(std::vector<TerrainData> terrain_data_vector) {
    this->terrain_data_vector = terrain_data_vector;
}

void DataManager::update_ladder_data(std::vector<LadderData> ladder_data_vector) {
    this->ladder_data_vector = ladder_data_vector;
}

void DataManager::update_curr_order_ind(int curr_order_ind) {
    this->curr_order_ind = curr_order_ind;
}

void DataManager::save(int level) {
...
void DataManager::destroy_saved_level_data_file(int level) {
    std::string saved_datafile_path = get_saved_level_data_file_path(level);    
