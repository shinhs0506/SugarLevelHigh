...
enum class TEXTURE_ASSET_ID {
	PLAYER = 0,
	ENEMY = PLAYER + 1,
	ENEMY_ICE_CREAM = ENEMY + 1,
	TERRAIN1 = ENEMY_ICE_CREAM + 1,
	TERRAIN2 = TERRAIN1 + 1,
	...
	MELEE_ATTACK_TOOLTIP = MELEE_ATTACK + 1,
	BEAR_ADVANCED_ATTACK = MELEE_ATTACK_TOOLTIP + 1,
	CHOCOLATE_ADVANCED_ATTACK = BEAR_ADVANCED_ATTACK + 1,
	ADVANCED_ATTACK_TOOLTIP = CHOCOLATE_ADVANCED_ATTACK + 1,
	BACKGROUND1 = ADVANCED_ATTACK_TOOLTIP + 1,
	...
	HEALTH_POTION_TOOLTIP = HEALTH_ABILITY + 1,
	LEVEL_WON = HEALTH_POTION_TOOLTIP + 1,
