...
{
	Entity entity = createGenericButton(vec2(50, 50), vec2(64, 64), on_click); // try to uniform button position
...
{
    Entity entity = createGenericButton(vec2(1230, 50), vec2(64, 64), on_click); // try to uniform button position
